# Restore topics where they were removed
import pandas as pd
...
for filename in os.listdir(input_folder):
    ...
    # If <encodingDesc> already exists, remove it first
    existing_encoding_desc = tei_header.find("tei:encodingDesc", namespaces=NS)
